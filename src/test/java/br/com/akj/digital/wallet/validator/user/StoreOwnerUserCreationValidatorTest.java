...
class StoreOwnerUserCreationValidatorTest {

    @InjectMocks
    private StoreOwnerUserCreationValidator validator;
    ...
    public void validateCode_with_success() {
        ...
        verify(cnpjValidator).validate(code);
    }
    ...
    public void validate_with_success() {
        ...
        verify(cnpjValidator).validate(request.personRegistrationCode());
